...
def exportExcel(data, filename):
    ...
    for i, d in enumerate(data):
        ...
        #worksheet.write(2,start_col+1,'Intensity (' + s['y_units'] +')')
...
#%% 
''' This simulates the effect of convolution on a test spectrum
'''
...
#%%
'''
This plots the Poisson distirubuton at several pressures.
...
non_scattered = model.simulation.non
total_inel = model.simulation.inel
